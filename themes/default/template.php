	...
	//determine menu configuration
		...
		switch ($menu_style) {
			...
			case 'side':
				...
				echo "</div>\n";
				echo "<div id='content_container' style='padding: 25px; width: calc(100% - ".(is_numeric($_SESSION['theme']['menu_side_width_contracted']['text']) ? $_SESSION['theme']['menu_side_width_contracted']['text'] : '55')."px); float: left; padding-top: 0px; text-align: center;'>\n";
